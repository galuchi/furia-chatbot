        ...
        <div className="md:w-80 space-y-4">
          ...
          <div className="bg-zinc-900 p-4 rounded-lg border border-zinc-800 animate-slide-in">
            ...
            <div className="flex justify-between">
              <a href="https://x.com/FURIA" target="_blank" className="text-white hover:text-[#0085FF] transition-colors">
              ...
              <a href="https://www.instagram.com/furiagg/" target="_blank" className="text-white hover:text-[#0085FF] transition-colors">
                <div className="flex flex-col items-center">
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.twitch.tv/furiatv" target="_blank" className="text-white hover:text-[#0085FF] transition-colors">
                <div className="flex flex-col items-center">
                 <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.265 0L1.47 4.235v15.53h5.29V24l4.235-4.235h3.528l6.59-6.59V0H4.265zm15.53 12.47l-3.528 3.53h-3.53L8.5 19.236v-3.236H4.235V1.765h15.53v10.705z"/>
                    <path d="M14.47 5.293h1.764v5.294H14.47V5.293zm-4.235 0h1.764v5.294H10.235V5.293z"/>
                 </svg>
                  <span className="mt-1 text-sm">Twitch</span>
                </div>
              </a>
            </div>
          </div>
