        ...
        <div className="md:w-80 space-y-4">
          ...
          <div className="bg-zinc-900 p-4 rounded-lg border border-zinc-800 animate-slide-in">
            ...
            <div className="flex justify-between">
              <a href="https://x.com/FURIA" className="text-white hover:text-[#0085FF] transition-colors">
              ...
              <a href="https://www.instagram.com/furiagg/" className="text-white hover:text-[#0085FF] transition-colors">
                <div className="flex flex-col items-center">
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.twitch.tv/furiatv" className="text-white hover:text-[#0085FF] transition-colors">
                <div className="flex flex-col items-center">
